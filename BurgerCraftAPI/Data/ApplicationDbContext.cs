    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BurgerIngredient>().HasData(
                new BurgerIngredient { BurgerId = 1, IngredientId = 1, Quantity = 1 },
                new BurgerIngredient { BurgerId = 1, IngredientId = 2, Quantity = 1 },
                new BurgerIngredient { BurgerId = 2, IngredientId = 1, Quantity = 1 },
                new BurgerIngredient { BurgerId = 2, IngredientId = 3, Quantity = 1 },
                new BurgerIngredient { BurgerId = 3, IngredientId = 2, Quantity = 1 },
                new BurgerIngredient { BurgerId = 3, IngredientId = 4, Quantity = 1 }
            );
        }
    }
}
